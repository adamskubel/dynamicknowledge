define(function(require, exports, module) {
    ...
    function PositioningScrollView(options) {
        ...
        this.children = [];
        this.scrollView.sequenceFrom(this.children);
        this.lastOffset = 0;
        this.scrollView._particle.on('update',function(){
            var newOffset = this.scrollView.getOffset();
    ...
    PositioningScrollView.prototype.addChild = function(child, config){
        ...
        if (child.textSurface && child.backSurface){
            child.textSurface.pipe(this.scrollView);
            child.backSurface.pipe(this.scrollView);
        }
